        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
          {POSITIONS.map((pos, i) => (
            <FadeInOnScroll key={i}>
              <div className="bg-bianco border border-[#E8E8E8] p-5 md:p-8 h-full flex flex-col hover:-translate-y-1 hover:border-l-[3px] hover:border-l-giallo transition-all duration-200">
