...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const heroEls = document.querySelectorAll('.hero-subtitle, .hero-body, .hero .btn');
  if (heroEls.length) {
    gsap.from(heroEls, {
      opacity: 0,
      y: 30,
  ...
  if (typeof ScrollTrigger !== 'undefined') {
    ...
    document.querySelectorAll('.faq-header, .testimonials-header, .cta-inner, .ai-scary-content, .page-hero, .page-section').forEach(el => {
      gsap.from(el, {
        opacity: 0,
        y: 40,
        duration: 0.8,
